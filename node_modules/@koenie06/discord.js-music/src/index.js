...
exports.play = async (options = {}) => {
    ...
    if(!song || typeof song !== 'string') throw new Error(`INVALID_MUSIC_URL: There is no valid Music URL provided. ${song}`);
    ...
    if(songInfo.type === 'list') {
        ...
        for(const video of playlistSongs.videos) {
            const ytdlSongInfo = await ytdl.getInfo(video.videoId, {
                requestOptions: {
                  headers: {
                    cookie: '__Secure-3PAPISID=SH0mPXgHzIbza_T3/AUtkK4_0st9Mbfh1N;__Secure-3PSID=CAi2MBcz18UXS1c0cGQ70rpUyFVyedK6iwtQsUv5zfdoG6WULPTqPo7a4QTGoPuUV_1rsQ.;__Secure-3PSIDCC=AJi4QfG_LuSWENAYGWcacqw41Tud6q5MlsB3jtaPyPD8NIr9dG20-Yq0v2Nkz6umcOblb5k6eg;_fbp=fb.1.1632606458102.62759067;GPS=1;LD_S=true;LOGIN_INFO=AFmmF2swRQIhAOaIaOaQBQCEPQ4XS8eqJyxN0FRW-sLJlYve2us4pJluAiBhV3q-LOMCK_TOd4Fix3WOKt7Ive6gE3VEY_iIVJ9VFw:QUQ3MjNmeFpaUi05ZFU5NW9DaDlqU2dLQXdxTk9COWo1X1pJbkVtdl8zVXRQcFBpSm5YUklEdDNTSnNWdUJPR0FuX3VDb2xZeE1RdWNzN2JKLWJtWDI2eHVBMjV1c0hqLVZ2SjZrVFBtVVdKUXFjSUVGTmtHSDdoTzllSC1tZlBVZmxnOW1FZTdiM1NuVk1sRFU1cXk2MXJZbWhEM0hHb2dn;PREF=tz=America.Chicago;VISITOR_INFO1_LIVE=ZhbgkEcWLT0;YSC=ghst4ulCQ74;LD_T=fd7f41d4-51f7-48fa-d0a6-535d67cd1794;',
                    'x-youtube-identity-token': 'QUFFLUhqbEhsNXMwZTd2M09ScGZReF8xY0RXMXRfWVh0d3w\u003d',
                  },
                },
              } );
...
async function playSong(data, interaction) {
    ...
    let resource = await createAudioResource(ytdl(data.queue[0].url, { filter: 'audioonly', quality: 'lowestaudio',
        requestOptions: {
          headers: {
            cookie: '__Secure-3PAPISID=SH0mPXgHzIbza_T3/AUtkK4_0st9Mbfh1N;__Secure-3PSID=CAi2MBcz18UXS1c0cGQ70rpUyFVyedK6iwtQsUv5zfdoG6WULPTqPo7a4QTGoPuUV_1rsQ.;__Secure-3PSIDCC=AJi4QfG_LuSWENAYGWcacqw41Tud6q5MlsB3jtaPyPD8NIr9dG20-Yq0v2Nkz6umcOblb5k6eg;_fbp=fb.1.1632606458102.62759067;GPS=1;LD_S=true;LOGIN_INFO=AFmmF2swRQIhAOaIaOaQBQCEPQ4XS8eqJyxN0FRW-sLJlYve2us4pJluAiBhV3q-LOMCK_TOd4Fix3WOKt7Ive6gE3VEY_iIVJ9VFw:QUQ3MjNmeFpaUi05ZFU5NW9DaDlqU2dLQXdxTk9COWo1X1pJbkVtdl8zVXRQcFBpSm5YUklEdDNTSnNWdUJPR0FuX3VDb2xZeE1RdWNzN2JKLWJtWDI2eHVBMjV1c0hqLVZ2SjZrVFBtVVdKUXFjSUVGTmtHSDdoTzllSC1tZlBVZmxnOW1FZTdiM1NuVk1sRFU1cXk2MXJZbWhEM0hHb2dn;PREF=tz=America.Chicago;VISITOR_INFO1_LIVE=ZhbgkEcWLT0;YSC=ghst4ulCQ74;LD_T=fd7f41d4-51f7-48fa-d0a6-535d67cd1794;',
            'x-youtube-identity-token': 'QUFFLUhqbEhsNXMwZTd2M09ScGZReF8xY0RXMXRfWVh0d3w\u003d',
